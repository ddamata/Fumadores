...
/*Realiza el manejo del hilo de servidor de descarga 2 correspondiente a un usuario, contiene toda la interaccion entre el cliente y el servidor de descarga 2*/
	...
	public void run() {
	    ...
	    try {
	      ...
	      while (true) {  
	    	...
	    	salida.println("Bienvenido al servidor de descarga numero (2), presione enter para descargar.");
