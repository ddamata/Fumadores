...
public class Transferencia {	
	  ...
	  int puerto = 0;
	  Socket sockett;
/*Contiene el método de descarga de parte del servidor de descarga 3*/
   public Transferencia( String nombrearchivo, Socket socket )
   {
        nombredearchivo = nombrearchivo;
        sockett = socket;
   }
   /*Realiza la transferencia del archivo entre el hilo del servidor de descarga 3 y el cliente.*/
